...
<body>
    ...
    <form action="paso3.php" method="GET">
        ...
        for($i=1; $i<=$cant; $i++){
            echo '<div>';
            echo '<label>Ingrsese URL del enlace </label>';
            echo '<input class="input" type="url" name="url'.$i.'">';
            echo '</div>';
            echo '<div>';
            echo '<label> Ingrsese nombre del enlace </label>';
        ...
        <input type="color" name="fondo" class="color2">
        <label class="color">Color de letra</label>
        <input type="color" name="letra" class="color2">
